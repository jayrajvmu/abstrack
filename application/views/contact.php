                    ...
                    <div class="col-xl-5 col-lg-6">
                        <div class="contact-form-box shadow-box mb--30">
                            ...
                            <form method="POST" action="<?php echo base_url('controll/contactdataget'); ?>">
                                ...
                                <div class="form-group">
                                    <label>Company</label>
                                    <input type="text" class="form-contact_company" name="contact_company"required >
                                    
                                </div>
                                <div class="form-group mb--40">
                                    <label>How can we help you?</label>                                    
                                    <textarea name="contact_message"  class="form-control textarea" cols="30" rows="4" required maxlength="200"></textarea>
