                    ...
                    <div class="row row-35 isotope-list">
                        <div class="col-md-6 project branding">
                            <div class="project-grid">
                                ...
                                <div class="content">
                                    <h4 class="title"><a href="<?php echo base_url(); ?>portfolio">Creative Agency</a></h4>
                        ...
                        <div class="col-md-6 project mobile">
                            <div class="project-grid">
                                ...
                                <div class="content">
                                    <h4 class="title"><a href="<?php echo base_url(); ?>portfolio">Digital Marketing</a></h4>
                        ...
                        <div class="col-md-6 project branding">
                            <div class="project-grid">
                                ...
                                <div class="content">
                                    <h4 class="title"><a href="<?php echo base_url(); ?>portfolio">Digital Agency</a></h4>
                        ...
                        <div class="col-md-6 project mobile">
                            <div class="project-grid">
                                ...
                                <div class="content">
                                    <h4 class="title"><a href="<?php echo base_url(); ?>portfolio">Social Engagement</a></h4>
                        ...
                        <div class="col-md-6 project branding">
                            <div class="project-grid">
                                ...
                                <div class="content">
                                    <h4 class="title"><a href="<?php echo base_url(); ?>portfolio">Plan Management</a></h4>
                        ...
                        <div class="col-md-6 project mobile">
                            <div class="project-grid">
                                ...
                                <div class="content">
                                    <h4 class="title"><a href="<?php echo base_url(); ?>portfolio">Web Application</a></h4>
